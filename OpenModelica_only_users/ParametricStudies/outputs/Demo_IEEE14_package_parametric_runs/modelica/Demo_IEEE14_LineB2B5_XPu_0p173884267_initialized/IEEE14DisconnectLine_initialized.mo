within Demo_IEEE14_LineB2B5_XPu_0p173884267_initialized;
...
// Switch off signals for generators, loads, lines, transformers and bank
  ...
  LineB1B5.switchOffSignal2 = if time < 100 then false else true;
...
end IEEE14DisconnectLine_initialized;
