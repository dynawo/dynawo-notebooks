within MyIEEE14_LineB2B5_XPu_0p12_initialized;
...
model IEEE14Base_initialized "Base class for IEEE 14-bus system benchmark formed with 14 buses, 5 generators (2 generators and 3 synchronous condensers), 1 shunt, 3 transformers, 17 lines and 11 loads"
  ...
  // Generators
  Dynawo.Electrical.Machines.SignalN.GeneratorPV Gen1(PNom = 1090, QGen0Pu = -0.1715673416727094, u0Pu = Complex(1.06, 0.0), i0Pu = Complex(-2.194423118754383, -0.1618559827101032), UDeadBandPu = 1e-4, U0Pu = 1.06, URef0Pu = 1.06, limUQUp0 = false, limUQDown0 = false, PGen0Pu = 2.3260885058796457, QDeadBandPu = 1e-4, PMaxPu = 10.9, QMinPu = -100, KGover = 1, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPV.QStatus.Standard, PMinPu = 0, PRef0Pu = -2.3260885058796457, QMaxPu = 100, QNomAlt = 10000) annotation(
    Placement(visible = true, transformation(origin = {-170, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPV Gen2(PNom = 1008, QGen0Pu = 0.43009391044300205, u0Pu = Complex(1.0409334655717604, -0.09291396793144027), i0Pu = Complex(-0.3446439327127736, 0.4439439801284634), UDeadBandPu = 1e-4, U0Pu = 1.045072, URef0Pu = 1.045072, limUQUp0 = false, limUQDown0 = false, PGen0Pu = 0.4, QDeadBandPu = 1e-4, PMaxPu = 10.08, QMinPu = -100, KGover = 1, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPV.QStatus.Standard, PMinPu = 0, PRef0Pu = -0.4, QMaxPu = 100, QNomAlt = 10000) annotation(
    Placement(visible = true, transformation(origin = {-90, -160}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPV Gen3(PNom = 1485, QGen0Pu = 0.2511181634043655, u0Pu = Complex(0.9855218397680147, -0.22101290310809396), i0Pu = Complex(0.054406778077807603, 0.2426060527374132), UDeadBandPu = 1e-4, U0Pu = 1.01, URef0Pu = 1.01, limUQUp0 = false, limUQDown0 = false, PGen0Pu = -0.0, QDeadBandPu = 1e-4, PMaxPu = 14.85, QMinPu = -100, KGover = 0, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPV.QStatus.Standard, PMinPu = 0, PRef0Pu = 0.0, QMaxPu = 100, QNomAlt = 10000) annotation(
    Placement(visible = true, transformation(origin = {90, -200}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPV Gen6(PNom = 74.4, QGen0Pu = 0.1291020887586211, u0Pu = Complex(1.0391431996360847, -0.2563241985261637), i0Pu = Complex(0.028888164036170637, 0.11711316910679546), UDeadBandPu = 1e-4, U0Pu = 1.07029, URef0Pu = 1.07029, limUQUp0 = false, limUQDown0 = false, PGen0Pu = -0.0, QDeadBandPu = 1e-4, PMaxPu = 0.744, QMinPu = -100, KGover = 0, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPV.QStatus.Standard, PMinPu = 0, PRef0Pu = 0.0, QMaxPu = 100, QNomAlt = 10000) annotation(
    Placement(visible = true, transformation(origin = {-60, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPV Gen8(PNom = 228, QGen0Pu = 0.1755839141692526, u0Pu = Complex(1.0616619424628415, -0.2462881258831334), i0Pu = Complex(0.03640749162410996, 0.15693995859221105), UDeadBandPu = 1e-4, U0Pu = 1.089855, URef0Pu = 1.089855, limUQUp0 = false, limUQDown0 = false, PGen0Pu = -0.0, QDeadBandPu = 1e-4, PMaxPu = 2.28, QMinPu = -100, KGover = 0, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPV.QStatus.Standard, PMinPu = 0, PRef0Pu = 0.0, QMaxPu = 100, QNomAlt = 10000) annotation(
    Placement(visible = true, transformation(origin = {170, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  // Generators control
  Dynawo.Electrical.Controls.Frequency.SignalN ModelSignalN;
  Dynawo.Types.Angle Theta_Bus1;
  // Loads
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load2(tFilter = tfilter, u0Pu = Complex(1.0409334655717606, -0.09291396793144029), Beta = beta, i0Pu = Complex(0.1960147348168251, -0.139502198351456), s0Pu = Complex(0.217, 0.127), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load3(tFilter = tfilter, u0Pu = Complex(0.9855218397680165, -0.22101290310809438), Beta = beta, i0Pu = Complex(0.868904148094236, -0.3876515089537756), s0Pu = Complex(0.942, 0.19), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load4(tFilter = tfilter, u0Pu = Complex(1.0021363947348563, -0.17738840340193765), Beta = beta, i0Pu = Complex(0.4691693553020288, -0.044130921793180004), s0Pu = Complex(0.478, -0.039), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load5(tFilter = tfilter, u0Pu = Complex(1.0085589597859037, -0.14833021443359867), Beta = beta, i0Pu = Complex(0.07147584281280103, -0.02637627362597823), s0Pu = Complex(0.076, 0.016), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load6(tFilter = tfilter, u0Pu = Complex(1.0391431996360876, -0.2563241985261644), Beta = beta, i0Pu = Complex(0.08481708346114616, -0.09309657318970481), s0Pu = Complex(0.112, 0.075), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load9(tFilter = tfilter, u0Pu = Complex(1.0216642292548892, -0.2666423803880881), Beta = beta, i0Pu = Complex(0.23062987269746746, -0.22267168775260884), s0Pu = Complex(0.295, 0.166), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load10(tFilter = tfilter, u0Pu = Complex(1.0162287238488628, -0.26805309178200953), Beta = beta, i0Pu = Complex(0.06872654558396707, -0.07520193164963658), s0Pu = Complex(0.09, 0.058), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load11(tFilter = tfilter, u0Pu = Complex(1.0236075884672085, -0.2637342533284637), Beta = beta, i0Pu = Complex(0.02781550452467904, -0.024751576289806267), s0Pu = Complex(0.035, 0.018), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load12(tFilter = tfilter, u0Pu = Complex(1.0208498242624968, -0.2680928910062635), Beta = beta, i0Pu = Complex(0.05204840952400814, -0.02934203236329019), s0Pu = Complex(0.061, 0.016), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load13(tFilter = tfilter, u0Pu = Complex(1.0157656749235673, -0.2683544318276673), Beta = beta, i0Pu = Complex(0.11013269527638085, -0.08619566404735125), s0Pu = Complex(0.135, 0.058), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load14(tFilter = tfilter, u0Pu = Complex(0.9969577177661247, -0.2802722241083172), Beta = beta, i0Pu = Complex(0.12544144286660894, -0.08541761668528249), s0Pu = Complex(0.149, 0.05), UMinPu = uMinPu, UMaxPu = uMaxPu, Alpha = alpha) annotation(
