model Demo_BESS_BESS_RMvHvPu_0p3_auxiliary "WECC BESS with REEC-C and REGC-B with a plant controller REPC-A on infinite bus"
  ...
  Dynawo.Electrical.Controls.WECC.BaseClasses_INIT.WECCPlantCurrentSource_INIT BESS_INIT(PPCLocal = true, GMvHvPu = 0, U0Pu = 1, rTfoPu = 1, QPcc0Pu = 0, SNom = 6, UPcc0Pu = 1, P0Pu = -0.03, RLvTrPu = 0, XLvTrPu = 0, RMvHvPu = 0.3, XMvHvPu = 1e-10, BMvHvPu = 0, ConverterLVControl = true, PPcc0Pu = 0, Q0Pu(fixed = false), UPhase0(fixed = false));
equation
...
end Demo_BESS_BESS_RMvHvPu_0p3_auxiliary;