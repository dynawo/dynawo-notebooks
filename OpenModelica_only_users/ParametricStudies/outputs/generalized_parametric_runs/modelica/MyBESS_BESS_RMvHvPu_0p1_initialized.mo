model MyBESS_BESS_RMvHvPu_0p1_initialized "WECC BESS with REEC-C and REGC-B with a plant controller REPC-A on infinite bus"
...
end MyBESS_BESS_RMvHvPu_0p1_initialized;