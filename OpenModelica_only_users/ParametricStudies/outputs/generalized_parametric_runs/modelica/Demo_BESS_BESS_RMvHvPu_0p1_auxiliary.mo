model Demo_BESS_BESS_RMvHvPu_0p1_auxiliary "WECC BESS with REEC-C and REGC-B with a plant controller REPC-A on infinite bus"
...
end Demo_BESS_BESS_RMvHvPu_0p1_auxiliary;