model MyBESS_BESS_RPu_0p5_auxiliary "WECC BESS with REEC-C and REGC-B with a plant controller REPC-A on infinite bus"
  ...
  Dynawo.Electrical.BESS.WECC.BESS_INIT BESS_INIT(RPu = 0.5, SNom = 6, P0Pu = -0.03, U0Pu = 1, XPu = 1e-10, Q0Pu(fixed = false), UPhase0(fixed = false));
equation
...
end MyBESS_BESS_RPu_0p5_auxiliary;