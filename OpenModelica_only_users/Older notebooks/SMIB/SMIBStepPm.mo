...
model SMIBStepPm "Synchronous machine infinite bus - Step on Pm"
  ...
  */
  ...
  // Generator
  Dynawo.Examples.BaseClasses.GeneratorSynchronousInterfaces generatorSynchronous(DPu = 0, ExcitationPu = Dynawo.Electrical.Machines.OmegaRef.BaseClasses.GeneratorSynchronousParameters.ExcitationPuType.NoLoad, H = 3.5, LDPPu = 0.16634, LQ1PPu = 0.92815, LQ2PPu = 0.12046, LdPPu = 0.15, LfPPu = 0.1699, LqPPu = 0.15, MdPPu = 1.66, MdPPuEfd = 1, MqPPu = 1.61, MrcPPu = 0, MsalPu = 0.05, P0Pu = -19.98, PNomAlt = 2200, PNomTurb = 2220, Q0Pu = -9.68, RDPPu = 0.03339, RQ1PPu = 0.00924, RQ2PPu = 0.02821, RTfPu = 0, RaPPu = 0.003, RfPPu = 0.00074, SNom = 2220, SnTfo = 2220, U0Pu = 1, UBaseHV = 24, UBaseLV = 24, UNom = 24, UNomHV = 24, UNomLV = 24, UPhase0 = 0.494442, XTfPu = 0, md = 0.031, mq = 0.031, nd = 6.93, nq = 6.93) annotation(
