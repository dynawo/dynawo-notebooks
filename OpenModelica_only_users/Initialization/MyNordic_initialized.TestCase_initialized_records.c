/* Additional record code for MyNordic_initialized.TestCase_initialized generated by the OpenModelica Compiler OpenModelica 1.26.1~3-gfa676b4. */
...
#define Dynawo_Types_ComplexAdmittancePu__desc_added 1
const char* Dynawo_Types_ComplexAdmittancePu__desc__fields[2] = {"re","im"};
struct record_description Dynawo_Types_ComplexAdmittancePu__desc = {
  "Dynawo_Types_ComplexAdmittancePu", /* package_record__X */
  "Dynawo.Types.ComplexAdmittancePu", /* package.record_X */
  Dynawo_Types_ComplexAdmittancePu__desc__fields
};

void Dynawo_Types_ComplexAdmittancePu_construct_p(threadData_t *threadData, void* v_ths ) {
  Dynawo_Types_ComplexAdmittancePu* ths = (Dynawo_Types_ComplexAdmittancePu*)(v_ths);
  // ths->_re has no default value.
  // ths->_im has no default value.
}
void Dynawo_Types_ComplexAdmittancePu_wrap_vars_p(threadData_t *threadData, void* v_dst , modelica_real in_re, modelica_real in_im) {
  Dynawo_Types_ComplexAdmittancePu* dst = (Dynawo_Types_ComplexAdmittancePu*)(v_dst);
  dst->_re = in_re;
  dst->_im = in_im;
}

void Dynawo_Types_ComplexAdmittancePu_copy_p(void* v_src, void* v_dst) {
  Dynawo_Types_ComplexAdmittancePu* src = (Dynawo_Types_ComplexAdmittancePu*)(v_src);
  Dynawo_Types_ComplexAdmittancePu* dst = (Dynawo_Types_ComplexAdmittancePu*)(v_dst);
  dst->_re = src->_re;
  dst->_im = src->_im;
}
...
#define Dynawo_Types_ComplexImpedancePu__desc_added 1
const char* Dynawo_Types_ComplexImpedancePu__desc__fields[2] = {"re","im"};
struct record_description Dynawo_Types_ComplexImpedancePu__desc = {
  "Dynawo_Types_ComplexImpedancePu", /* package_record__X */
  "Dynawo.Types.ComplexImpedancePu", /* package.record_X */
  Dynawo_Types_ComplexImpedancePu__desc__fields
};

void Dynawo_Types_ComplexImpedancePu_construct_p(threadData_t *threadData, void* v_ths ) {
  Dynawo_Types_ComplexImpedancePu* ths = (Dynawo_Types_ComplexImpedancePu*)(v_ths);
  // ths->_re has no default value.
  // ths->_im has no default value.
}
void Dynawo_Types_ComplexImpedancePu_wrap_vars_p(threadData_t *threadData, void* v_dst , modelica_real in_re, modelica_real in_im) {
  Dynawo_Types_ComplexImpedancePu* dst = (Dynawo_Types_ComplexImpedancePu*)(v_dst);
  dst->_re = in_re;
  dst->_im = in_im;
}

void Dynawo_Types_ComplexImpedancePu_copy_p(void* v_src, void* v_dst) {
  Dynawo_Types_ComplexImpedancePu* src = (Dynawo_Types_ComplexImpedancePu*)(v_src);
  Dynawo_Types_ComplexImpedancePu* dst = (Dynawo_Types_ComplexImpedancePu*)(v_dst);
  dst->_re = src->_re;
  dst->_im = src->_im;
}
