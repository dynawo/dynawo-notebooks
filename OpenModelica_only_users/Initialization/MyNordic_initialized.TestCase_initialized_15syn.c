...
void MyNordic_initialized_TestCase_initialized_function_initSynchronous(DATA *data, threadData_t *threadData)
{
...
/* Update base-clock. */
void MyNordic_initialized_TestCase_initialized_function_updateSynchronous(DATA *data, threadData_t *threadData, long base_idx)
{
...
int MyNordic_initialized_TestCase_initialized_function_equationsSynchronous(DATA *data, threadData_t *threadData, long base_idx, long sub_idx)
{
  int ret;
...
/* %v% = pre(%v%)*/
void MyNordic_initialized_TestCase_initialized_function_savePreSynchronous(DATA *data, threadData_t *threadData)
{
}
