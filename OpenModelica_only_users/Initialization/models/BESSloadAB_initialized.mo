model BESSloadAB_initialized "WECC BESS with REEC-C and REGC-B with a plant controller REPC-A on infinite bus"
  ...
  Dynawo.Electrical.Loads.LoadAlphaBeta loadAB1(u0Pu = Complex(0.9999999143838794, -4.7520300000000005e-7), i0Pu = Complex(0.19999999336302637, -0.05000009932141138), alpha = 2, s0Pu = Complex(0.2, 0.05), beta = 2) annotation(
