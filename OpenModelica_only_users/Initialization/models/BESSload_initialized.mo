model BESSload_initialized "WECC BESS with REEC-C and REGC-B with a plant controller REPC-A on infinite bus"
  ...
  Dynawo.Electrical.Loads.LoadPQ loadPQ1(u0Pu = Complex(0.9999999143838794, -4.75203e-7), i0Pu = Complex(0.19999999336302637, -0.05000009932141139), s0Pu = Complex(0.2, 0.05)) annotation(
