...
model DIGrid
  ...
  Dynawo.Electrical.Sources.InertialGrid.InertialGrid inertialGrid1(DPu = 2, Fh = 0, H = 2.6, Km = 1, R = 0.05, SNom = SNom, Tr = 15, U0Pu = 1, UPhase0 = 0) annotation(
    Placement(visible = true, transformation(origin = {-38, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Sources.InertialGrid.InertialGrid inertialGrid2(DPu = 2, Fh = 0, H = 2.6, Km = 1, P0Pu = 3.3, R = 0.05, SNom = SNom, Tr = 15, U0Pu = 0.9546) annotation(
    Placement(visible = true, transformation(origin = {-38, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Loads.LoadZIP load(Ip = 0, Iq = 0, Pp = 1, Pq = 1, Zp = 0, Zq = 0) annotation(
