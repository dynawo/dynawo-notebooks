...
model IEEE14Base "Base class for IEEE 14-bus system benchmark formed with 14 buses, 5 generators (2 generators and 3 synchronous condensers), 1 shunt, 3 transformers, 17 lines and 11 loads"
  ...
  // Generators
  Dynawo.Electrical.Machines.SignalN.GeneratorPV Gen1(KGover = 1, PGen0Pu = 2.3239, PMaxPu = 10.9, PMinPu = 0, PNom = 1090, PRef0Pu = -2.3239, QGen0Pu = -0.1655, QMaxPu = 100, QMinPu = -100, QNomAlt = 10000, U0Pu = U0Pu_Gen1, URef0Pu = U0Pu_Gen1, i0Pu = Complex(-2.192358, -0.156132), limUQDown0 = false, limUQUp0 = false, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPV.QStatus.Standard, u0Pu = Complex(U0Pu_Gen1 * Modelica.Math.cos(UPhase0_Gen1), U0Pu_Gen1 * Modelica.Math.sin(UPhase0_Gen1)), UDeadBandPu=1e-4, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-170, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPV Gen2(KGover = 1, PGen0Pu = -P0Pu_Gen2, PMaxPu = 10.08, PMinPu = 0, PNom = 1008, PRef0Pu = P0Pu_Gen2, QGen0Pu = 0.4356, QMaxPu = 100, QMinPu = -100, QNomAlt = 10000, U0Pu = U0Pu_Gen2, URef0Pu = U0Pu_Gen2, i0Pu = Complex(-0.345121, 0.448465), limUQDown0 = false, limUQUp0 = false, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPV.QStatus.Standard, u0Pu = Complex(1.041127, -0.090721), UDeadBandPu=1e-4, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-90, -160}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPV Gen3(KGover = 0, PGen0Pu = -P0Pu_Gen3, PMaxPu = 14.85, PMinPu = 0, PNom = 1485, PRef0Pu = P0Pu_Gen3, QGen0Pu = 0.250700, QMaxPu = 100, QMinPu = -100, QNomAlt = 10000, U0Pu = U0Pu_Gen3, URef0Pu = U0Pu_Gen3, i0Pu = Complex(0.054697, 0.242116), limUQDown0 = false, limUQUp0 = false, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPV.QStatus.Standard, u0Pu = Complex(0.985173, -0.222561), UDeadBandPu=1e-4, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {90, -200}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPV Gen6(KGover = 0, PGen0Pu = -P0Pu_Gen6, PMaxPu = 0.744, PMinPu = 0, PNom = 74.4, PRef0Pu = P0Pu_Gen6, QGen0Pu = 0.1273, QMaxPu = 100, QMinPu = -100, QNomAlt = 10000, U0Pu = U0Pu_Gen6, URef0Pu = U0Pu_Gen6, i0Pu = Complex(0.029217, 0.115295), limUQDown0 = false, limUQUp0 = false, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPV.QStatus.Standard, u0Pu = Complex(1.037496, -0.262912), UDeadBandPu=1e-4, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-60, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPV Gen8(KGover = 0, PGen0Pu = -P0Pu_Gen8, PMaxPu = 2.28, PMinPu = 0, PNom = 228, PRef0Pu = P0Pu_Gen8, QGen0Pu = 0.1762, QMaxPu = 100, QMinPu = -100, QNomAlt = 10000, U0Pu = U0Pu_Gen8, URef0Pu = U0Pu_Gen8, i0Pu = Complex(0.037358, 0.157298), limUQDown0 = false, limUQUp0 = false, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPV.QStatus.Standard, u0Pu = Complex(1.060361, -0.251831), UDeadBandPu=1e-4, QDeadBandPu=1e-4) annotation(
  ...
  // Loads
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load2(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load3(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load4(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load5(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load6(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load9(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load10(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load11(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load12(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load13(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaRestorative Load14(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, tFilter = tfilter) annotation(
