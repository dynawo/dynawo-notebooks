...
model TestCase "Nordic test system case with variable reference frequency"
  extends Demo_Nordic.FullDynamicModel(
    Alpha = 1,
    Beta = 2,
    P0Pu_g01 = -6,
    P0Pu_g02 = -3,
...
equation
  ...
  annotation(preferredView = "diagram",
    ...
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection --maxSizeLinearTearing=1040 --maxSizeNonlinearTearing=1040",
    __OpenModelica_simulationFlags(lv = "LOG_STATS", newtonMaxStepFactor = "0.1"),
