...
def fiche2():
    ...
    network.create_generators(id='GenerationUnit', voltage_level_id='ProducerGenerationUnit_VL', bus_id='ProducerGenerationUnit_Bus',
                              target_p=75, min_p=0, max_p=100, target_q=0, target_v=1.0444444444444445*nom_v, energy_source='OTHER',
    ...
    parameters = pp.loadflow.Parameters(distributed_slack=True,
                                        provider_parameters={'voltageRemoteControl': 'true'})
    ...
    network.create_generators(id='GenerationUnit', voltage_level_id='ProducerGenerationUnit_VL', bus_id='ProducerGenerationUnit_Bus',
                              target_p=-generation_unit['p'], min_p=0, max_p=100, target_q=-generation_unit['q'], energy_source='OTHER',
    ...
    network.create_generators(id="InfiniteBus", voltage_level_id='TSONetwork_VL', bus_id='TSONetwork_Bus',
                              target_p=0, min_p=-10000, max_p=10000, target_v=generation_unit_bus['v_mag']*nom_v, voltage_regulator_on=True)
