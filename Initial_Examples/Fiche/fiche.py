...
def fiche():
    ...
    network.create_generators(id='GenerationUnit', voltage_level_id='ProducerGenerationUnit_VL', bus_id='ProducerGenerationUnit_Bus',
                              target_p=0.7603667061097353*SnRef, min_p=0, max_p=100, target_q=0.02144559036115612*SnRef, energy_source='OTHER',
    ...
    network.create_generators(id="InfiniteBus", voltage_level_id='TSONetwork_VL', bus_id='TSONetwork_Bus',
                              target_p=0, min_p=-10000, max_p=10000, target_v=1.045326553450806*nom_v, voltage_regulator_on=True)
    ...
    parameters = pp.loadflow.Parameters(distributed_slack=False,
                                        provider_parameters={'slackBusSelectionMode': 'NAME', 'slackBusesIds': 'TSONetwork_VL', 'voltageRemoteControl': 'true'})  # Do not compensate slack_bus imbalance
    ...
    model_mapping.add_infinite_bus(static_id='TSONetwork_Bus', parameter_set_id='InfiniteBus', model_name='InfiniteBus')
    model_mapping.add_synchronous_generator(static_id='GenerationUnit', parameter_set_id='GenerationUnit', model_name='GeneratorSynchronousFourWindingsProportionalRegulations')
