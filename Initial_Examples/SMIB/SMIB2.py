...
def smib2():
    ...
    network.create_lines(id='line1', voltage_level1_id='VL1', bus1_id='VL1_BUS1',
                         ...
                         b1=0, b2=0, g1=0, g2=0, r=0, x=0.022522*zb)

    network.create_lines(id='line2', voltage_level1_id='VL1', bus1_id='VL1_BUS1',
                         voltage_level2_id='VL2', bus2_id='VL2_BUS1',
                         b1=0, b2=0, g1=0, g2=0, r=0, x=0.04189*zb)
    ...
    network.create_2_windings_transformers(id='TR', voltage_level1_id='VL2', bus1_id='VL2_BUS1',
                                           ...
                                           b=0, g=0, r=0, x=0.00675*zb, rated_u1=1, rated_u2=1)

    network.create_generators(id='SM', voltage_level_id='VL3', bus_id='VL3_BUS1',
                              target_p=1998, min_p=0, max_p=2220, target_q=968, energy_source='NUCLEAR',
                              voltage_regulator_on=False)

    network.create_generators(id="InfiniteBus", voltage_level_id='VL1', bus_id='VL1_BUS1',
                              target_p=0, min_p=-10000, max_p=10000, target_v=1*nom_v, voltage_regulator_on=True)
    network.update_generators(id="InfiniteBus", regulated_element_id="SM")

    parameters = pp.loadflow.Parameters(distributed_slack=False, provider_parameters={'slackBusSelectionMode': 'NAME', 'slackBusesIds' : 'VL1_0', 'voltageRemoteControl': 'true'}) # Do not compensate slack_bus imbalance
