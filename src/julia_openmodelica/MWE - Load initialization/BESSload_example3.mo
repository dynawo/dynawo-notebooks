model BESSload_example3 "Infinite bus + Simplified PV Generator + Load PQ"
  ...
  Dynawo.Electrical.Loads.LoadPQ loadPQ1(
  i0Pu(re(start = 0.20, fixed = false), im(start = -0.05, fixed = false)),
  s0Pu(re(start = 0.20, fixed = false), im(start = 0.05, fixed = false)),
  u0Pu(re(start = 1, fixed = false), im(start = 0, fixed = false))) annotation(
