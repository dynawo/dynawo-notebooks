model Demo_BESS_BESS_RMvHvPu_0p0_initialized "WECC BESS with REEC-C and REGC-B with a plant controller REPC-A on infinite bus"
...
end Demo_BESS_BESS_RMvHvPu_0p0_initialized;