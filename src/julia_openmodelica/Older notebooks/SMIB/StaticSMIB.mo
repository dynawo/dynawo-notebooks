...
model StaticSMIB "Synchronous machine infinite bus - Step on Pm"
...
Dynawo.Electrical.Machines.OmegaRef.GeneratorSynchronousInt_INIT gen_INIT(
    DPu = 0,
...
initial equation
  gen_INIT.Q0Pu    = GenPV.QGenPu;
  gen_INIT.UPhase0 = GenPV.UPhase;
