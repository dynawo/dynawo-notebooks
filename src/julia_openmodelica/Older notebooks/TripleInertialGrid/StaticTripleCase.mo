...
model StaticTripleCase
  ...
  */
  ...
  Dynawo.Electrical.Machines.Simplified.GeneratorFictitious Gen3(Alpha = 0, Beta = 0, PGen0Pu = 3.9, QGen0Pu = 0, U0Pu = 1, i0Pu = ComplexMath.conj(Complex(Gen3.PGen0Pu, Gen3.QGen0Pu)/Gen3.u0Pu), u0Pu = Complex(1, 0)) annotation(
...
// No variations in the loads
  ...
  connect(Gen3.terminal, busIG3.terminal) annotation(
    Line(points = {{-26, -76}, {-2, -76}}, color = {0, 0, 255}));
  ...
  connect(busIG3.terminal, line4.terminal2) annotation(
    Line(points = {{-2, -76}, {58, -76}}, color = {0, 0, 255}));
  end StaticTripleCase;
