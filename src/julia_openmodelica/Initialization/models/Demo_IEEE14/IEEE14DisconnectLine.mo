...
model IEEE14DisconnectLine "IEEE 14-bus system benchmark formed with 14 buses, 5 generators (2 generators and 3 synchronous condensers), 1 shunt, 3 transformers, 17 lines and 11 loads. Disconnection of a line is represented at time 100 s of the simulation."
  extends Demo_IEEE14.IEEE14Base(
    U0Pu_Gen1 = 1.06,
    UPhase0_Gen1 = 0,
    P0Pu_Gen2 = -0.4,
    U0Pu_Gen2 = 1.045072,
    ...
    P0Pu_Load9 = 0.295000,
    Q0Pu_Load9 = 0.166000,
    P0Pu_Load10 = 0.090000,
    Q0Pu_Load10 = 0.058000,
    P0Pu_Load11 = 0.035000,
    Q0Pu_Load11 = 0.018000,
    P0Pu_Load12 = 0.061000,
    Q0Pu_Load12 = 0.016000,
    P0Pu_Load13 = 0.135000,
    Q0Pu_Load13 = 0.058000,
    P0Pu_Load14 = 0.149000,
    Q0Pu_Load14 = 0.050000);
...
equation
  ...
  LineB1B5.switchOffSignal2 = if time < 100 then false else true; // Disconnecting line B1B5
